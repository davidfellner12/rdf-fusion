...
pub async fn optimizer_passes_comparison_bsbm_business_intelligence() {
    ...
    println!("\n{}", "=".repeat(60));
    println!("BENCHMARK: BSBM Business Intelligence");
    println!("{}", "=".repeat(60));
    ...
    println!("\n{}", "=".repeat(60));
    if any_difference {
        println!("RESULT BSBM Business Intelligence: plans CHANGED");
    } else {
        println!("RESULT BSBM Business Intelligence: plans IDENTICAL");
    }
    println!("{}", "=".repeat(60));
}
